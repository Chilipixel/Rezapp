const CACHE = 'rezapp-shell-v10';
const SHELL = ['./','./index.html','./styles.css','./manifest.json','./assets/icon.svg','./assets/placeholder.svg','./src/app.js?v=1.2.1','./src/storage/indexedDb.js','./src/models/recipe.js','./src/components/icons.js','./src/components/editor.js','./src/utils/ingredients.js','./src/utils/image.js','./src/services/recipeImportService.js?v=1.1.0','./src/services/bringService.js?v=1.2.1'];
